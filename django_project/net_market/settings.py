"""
Django settings for net_market project.
...
SECRET_KEY = 'django-insecure-txru8n-p@@t+*_23-fkk+y*99%zv6nh%(2v=bz-8iak@#(mq*2'
...
WSGI_APPLICATION = 'net_market.wsgi.application'
